    ...
    <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="row-span-2">
                ...
                @if ($cover)
                    Photo de couverture:
                    <img src="{{ $cover->temporaryUrl() }}" class="my-5 rounded-lg border-4 p-5 border-gray-400">
                @else
                    <div class="my-5 p-5 w-full h-72 flex flex-col justify-center border-4 border-gray-400 rounded-lg">
                        ...
                        <x-input name="cover" type="file" wire:model="cover" accept=".jpg,.png" class="m-auto"/>
            ...
            <button class="bg-blue-500 w-1/4 text-white text-center rounded-md m-auto p-2 hover:bg-blue-700">
                Publier</button>
